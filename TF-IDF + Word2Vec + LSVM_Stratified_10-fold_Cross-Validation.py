...
class Word2VecVectorizer(BaseEstimator, TransformerMixin):
    def __init__(self, vector_size=200, window=5, min_count=1, workers=4, sg=1, random_state=7):
...
# TF-IDF + Word2Vec + Linear SVM Pipeline
...
# Tabakalı 10 Katlı Çapraz Doğrulama Sonuçlarının Yazdırılması
...
cm_df.to_csv(
    "linear_svm_tfidf_word2vec_multiclass_confusion_matrix.csv",
    encoding="utf-8-sig"
)
...
plt.title("Linear SVM TF-IDF + Word2Vec Karışıklık Matrisi")
...
plt.savefig(
    "linear_svm_tfidf_word2vec_multiclass_confusion_matrix.png",
    dpi=300,
    bbox_inches="tight"
)
