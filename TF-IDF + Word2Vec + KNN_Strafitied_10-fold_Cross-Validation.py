...
cm_df.to_csv(
    "knn_tfidf_word2vec_multiclass_confusion_matrix.csv",
    encoding="utf-8-sig"
)
...
plt.title("KNN TF-IDF + Word2Vec Karışıklık Matrisi")
...
plt.savefig(
    "knn_tfidf_word2vec_multiclass_confusion_matrix.png",
    dpi=300,
    bbox_inches="tight"
)
